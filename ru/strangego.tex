...
%\begin{frame}{Вот тут не хватает...}
                                        \btLstHL<4>{8}%
%        \begin{itemize}
%                \item Регулярные однотипные споры в различных Golang сообществах
%                \item Непонимание порождает вопросы и отвлекает
%                \item \textbf{Понимание} позволяет более эффективно использовать инструмент
%        \end{itemize}
%\end{frame}
